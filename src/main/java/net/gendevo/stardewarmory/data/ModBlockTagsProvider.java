...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        tag(Tags.Blocks.ORES).addTag(ModTags.Blocks.ORES_IRIDIUM).add(ModBlocks.CINDER_ORE.get());
        ...
        tag(BlockTags.NEEDS_IRON_TOOL).add(ModBlocks.GALAXY_FORGE.get());
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(ModBlocks.IRIDIUM_ORE.get()).add(ModBlocks.IRIDIUM_BLOCK.get()).add(ModBlocks.CINDER_ORE.get()).add(ModBlocks.GALAXY_FORGE.get());
        tag(BlockTags.WITHER_IMMUNE).add(ModBlocks.IRIDIUM_BLOCK.get());
    }
}
