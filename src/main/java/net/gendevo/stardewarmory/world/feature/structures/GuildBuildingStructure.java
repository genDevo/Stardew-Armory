package net.gendevo.stardewarmory.world.feature.structures;
...
public class GuildBuildingStructure extends Structure<NoFeatureConfig> {
    public GuildBuildingStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
