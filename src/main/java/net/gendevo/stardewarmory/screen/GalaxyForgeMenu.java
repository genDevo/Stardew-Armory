...
public class GalaxyForgeMenu extends AbstractContainerMenu {
    ...
    public GalaxyForgeMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }
    public GalaxyForgeMenu(int containerId, Inventory playerInventory, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.GALAXY_FORGE_CONTAINER.get(), containerId);
        checkContainerSize(playerInventory, 3);
        this.blockEntity = (GalaxyForgeBlockEntity) entity;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.GALAXY_FORGE.get());
    }
