...
public class GalaxyForgeScreenHandler extends ScreenHandler {
    ...
    public GalaxyForgeScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        ...
        // Our Slots
        this.addSlot(new GalaxyForgeSlot(inventory, SLOT_INPUT_MAIN, 42, 47, false));
        this.addSlot(new GalaxyForgeSlot(inventory, SLOT_INPUT_ONTO, 116, 47, false));
        this.addSlot(new GalaxyForgeSlot(inventory, SLOT_CINDER_SHARDS, 81, 19, true));
