package net.gendevo.testomodo.init;
...
@Mod.EventBusSubscriber(modid = TestoModo.MOD_ID)
public final class LootInjector {
    public static final class Tables {
        ...
        private static ResourceLocation inject(ResourceLocation lootTable) {
            ResourceLocation ret = TestoModo.getId("inject/" + lootTable.getPath());
    ...
    public static void onLootTableLoad(LootTableLoadEvent event) {
        Tables.get(event.getName()).ifPresent(injectorName -> {
            TestoModo.LOGGER.info("Injecting loot table '{}' into '{}'", injectorName, event.getName());
