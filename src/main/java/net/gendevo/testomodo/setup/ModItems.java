...
import net.gendev.testomodo.setup.items.*;
import net.gendevo.testomodo.setup.tools.ModItemTier;
import net.gendevo.testomodo.setup.items.*;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> PRISMATIC_SHARD = Registration.ITEMS.register("prismatic_shard", () ->
            new Item(new Item.Properties().tab(TestoModo.TAB_STARDEW)));
